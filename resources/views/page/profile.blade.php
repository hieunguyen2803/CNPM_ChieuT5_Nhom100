        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center"
                ...
                <div class="col-md-8 ftco-animate text-center">
                    <a href="{{asset('change_password')}}"><h1 class="mb-4">Change Password</h1></a>
                    <p>We care about your health Even the all-powerful Pointing has no control about the blind texts it
                    ...
                    <div class="tab-content pl-md-5" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade show active py-5" id="v-pills-master" role="tabpanel"
                            ...
                            <p>Inventore fugit error iure nisi reiciendis fugiat illo pariatur quam sequi quod iusto
                                ...
                                exercitationem vitae deserunt qui nihil ea, tempore et quam natus quaerat
                                doloremque.</p>
                        ...
                        <div class="tab-pane fade py-5" id="v-pills-sea" role="tabpanel"
                        ...
                        <div class="tab-pane fade py-5" id="v-pills-spa" role="tabpanel"
                        ...
                        <div class="flipper">
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    ...
                                    <div class="name align-self-center">Aldin Powell <span class="position">Ophthalmologist</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="flipper">
                            ...
                            <div class="back">
                                ...
                                <div class="author d-flex">
                                    ...
                                    <div class="name align-self-center">Aldin Powell <span class="position">Pulmonologist</span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row d-flex">
                <div class="col-md-6 ftco-animate">
                    <div class="blog-entry align-self-stretch d-flex">
                        <a href="blog-single.html" class="block-20 order-md-last"
